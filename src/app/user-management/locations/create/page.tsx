...
import { Button, Card, Input, Select, message, Tooltip } from 'antd'
...
export default function CreateEditLocationPage() {
  ...
  // Load countries data asynchronously
  useEffect(() => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Tooltip placement='bottom' title={addresses.length === 0 ? "Add at least one address" : ""}>
            <Button
              type="primary"
